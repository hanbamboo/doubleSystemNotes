...
public class JdbcSelect01 {
	public static void main(String[] args) {
		...
		try {
			...
			resultSet = statement.executeQuery("select ename,age,sex,salary from employee;");
			// executeQuery 语句只能运行 DQL 语句
			while (resultSet.next()) {
				System.out.print(resultSet.getString("ename") + "\t" + resultSet.getString("age") + "\t"
						+ resultSet.getString("sex") + "\t" + resultSet.getString("salary") + "\n");
			}
